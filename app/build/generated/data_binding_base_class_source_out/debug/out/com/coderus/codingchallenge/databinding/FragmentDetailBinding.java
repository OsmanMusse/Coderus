...
public final class FragmentDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView launcherDetails;

  private FragmentDetailBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView launcherDetails) {
  ...
  public static FragmentDetailBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.launcher_details;
      TextView launcherDetails = ViewBindings.findChildViewById(rootView, id);
      if (launcherDetails == null) {
        break missingId;
      }

      return new FragmentDetailBinding((ConstraintLayout) rootView, launcherDetails);
    }
